...
<div id="main_container">
	...
	<div class="header"><a href="../home-logado.php"><div align="left"><img src="../logo novo definitivo 2.png" /></div></a>
...
<form method="post" action="recebeListar.php">
<img src="imagens/toolbar_find.png" /> <input type="text" name="pesq" placeholder="Pesquisar em notícias" size="60"/>
...
while($dados= mysqli_fetch_array($consulta))
{
  ...
  <table  bordercolor="#FFFFFF" width="90%">
        ...
        <?php 
		 echo "<td width=\"20%\" style=\"border: 1px solid #fff\"><img width=\"290\" height=\"134\" src=\"".$dados['imagem1']."\" /></td>"; ?>
