...
echo "<script language='javascript' type='text/javascript'>alert('E-mail de respota enviada com sucesso para destinatário');window.location.href='mensagens.php'</script>";
