...
$consulta = mysqli_query ($con,"select * from adm where idadm='$id' and senha='$senhac'");

if (mysqli_num_rows ($consulta)>0 )

{
mysqli_query ($con,"UPDATE adm SET senha='".md5($nova)." 'WHERE idadm='$id'");

$_SESSION = array();
session_destroy();
echo "<script language='javascript' type='text/javascript'>alert('Senha alterada. Você ja pode fazer seu login com a nova senha.');window.location.href='login.php'</script>";	
}
else
{
